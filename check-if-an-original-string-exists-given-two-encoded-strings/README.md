<h2>2060. Check if an Original String Exists Given Two Encoded Strings</h2><h3>Hard</h3><hr><div><p>An original string, consisting of lowercase English letters, can be encoded by the following steps:</p>
