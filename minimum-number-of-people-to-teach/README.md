<h2>1733. Minimum Number of People to Teach</h2><h3>Medium</h3><hr><div><p>On a social network consisting of <code>m</code> users and some friendships between users, two users can communicate with each other if they know a common language.</p>
