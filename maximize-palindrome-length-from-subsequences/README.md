<h2>1771. Maximize Palindrome Length From Subsequences</h2><h3>Hard</h3><hr><div><p>You are given two strings, <code>word1</code> and <code>word2</code>. You want to construct a string in the following manner:</p>
